		...
		this.set("optimization.minimizer", "make", options => [
			{
				apply: compiler => {
					...
					console.log(
						`debug:WebpackOptionsDefaulter in optimization.minimizer`
					);
					// 这里引用了webpack里面内容，"../../../lib/RequestShortener", "../../../lib/ModuleFilenameHelpers"
					const TerserPlugin = require("terser-webpack-plugin");
					//const TerserPlugin = require("../node_modules/terser-webpack-plugin");
					console.log(
						`debug:WebpackOptionsDefaulter typeof TerserPlugin = ${typeof TerserPlugin}`
					);
					const SourceMapDevToolPlugin = require("./SourceMapDevToolPlugin");
					console.log(
						`debug:WebpackOptionsDefaulter typeof SourceMapDevToolPlugin = ${typeof SourceMapDevToolPlugin}`
					);
					new TerserPlugin({
						cache: true,
						parallel: true,
