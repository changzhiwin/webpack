...
class Compilation extends Tapable {
	...
	_addModuleChain(context, dependency, onModule, callback) {
		...
		console.log(
			`read:Compilation _addModuleChain start, bail = ${
				this.bail
			}, context = ${context}, profile = ${this.profile}, constructor = ${
	...
	addEntry(context, entry, name, callback) {
		...
		const idx = this._preparedEntrypoints.findIndex(slot => {
			/*
			console.log(
				`read:Compilation name = ${slot.name}, request = ${slot.request}` // read:Compilation name = app, request = ./src/index.js
			);
			*/
